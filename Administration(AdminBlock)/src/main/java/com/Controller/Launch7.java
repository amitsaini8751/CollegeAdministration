...
import com.Controller.Dao.NewAdmissionImp;
...
public class Launch7 extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response)
		...
		NewAdmissionImp nai=cxt.getBean("nai",NewAdmissionImp.class);
		nai.Save(RegistrationNumber, Studentname, Fathername, Mothername, Course, Subject, Dob, Aadhar, Batchfrom, Batchto, Addressline1, Addressline2, City, District, State, PIN);
